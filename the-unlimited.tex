...
Sicherheitgründen laufen normale Prozesse deswegen in Ring-3.
...
Kontextwechsel statt, da ein normaler Prozess z. B. nicht selbst auf Hardware
zugreifen darf. Das bedeutet, wie oben schon erwähnt, dass man den bedroffenden
...
Regel ob ein Prozess oder Benutzer auch dazu berechtigt ist. Der Kernel
beherbergt eine Liste aller ihm bekannten Systemaufrufe, die so genannte System
Call Table, welche als Sprungtabelle genutzt wird. Jedem Systemaufruf wird dort eine eindeutige Nummer zugeordnet.
...
man hier auch die Register der CPU.
